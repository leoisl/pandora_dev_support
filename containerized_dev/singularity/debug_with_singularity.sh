...
PANDORA_PATH=$(dirname $SCRIPTPATH)
sudo singularity exec -B $PANDORA_PATH:/pandora -B /home/leandro/git/datasets:/datasets pandora_debug.img bash /pandora_start.sh
